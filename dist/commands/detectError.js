...
export function shouldDetectError(text, exitCode) {
...
export async function runDetectError(options, context) {
    const text = firstNonEmpty(options.text, context.stdinText, context.env.CLAUDE_TOOL_OUTPUT, context.env.CODEX_TOOL_OUTPUT, context.env.TOOL_OUTPUT);
    const exitCode = parseInteger(firstNonEmpty(options.exitCode, context.env.CLAUDE_TOOL_EXIT_CODE, context.env.CODEX_TOOL_EXIT_CODE, context.env.TOOL_EXIT_CODE, context.env.EXIT_CODE));
