...
Template for creating skills extracted from self-optimization learnings. Copy and customize.
...
Brief introduction explaining the problem this skill solves and the repeatable rule behind it.
...
Why this knowledge matters. What repeat failures or confusion it prevents.
...
Extracted from self-optimization learning entry.
...
- [ ] Add `Skill-Path: [actual installed skill path]` to learning metadata
